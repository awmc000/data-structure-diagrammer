...
import com.appfx.util.BufferedImageFileWriter;
import com.appfx.util.TimeStamp;
...
public class BubbleSortArrayDiagrammer <T extends Comparable<T>> {
     ...
     */
    public ArrayList<BufferedImage> renderSortingOperation(T[] array, String title) { 
        int swapNum = 1;
        ...
        bufferedImage = arrayDiagrammer.renderDiagram(array, title);
        graphics = (Graphics2D) bufferedImage.getGraphics();
        String swapString = "SWAP " + swapNum ;
        graphics.setColor(Color.BLUE);
        graphics.drawString(swapString, 5, 20);
        bufferedImages.add(bufferedImage);
